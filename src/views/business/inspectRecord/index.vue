<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="社区名称" prop="addr">
        <el-input
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="送检编号" align="center" prop="id" />
      <el-table-column label="送检人" align="center" prop="sysUser.nickName" />
      <el-table-column label="送检机构" align="center" prop="inspectOrgInfo.name" />
      <el-table-column label="签收人" align="center" prop="signedBy" />
      <el-table-column label="送检时间" align="center" prop="inspectTime" />
      <el-table-column label="条形码" align="center" prop="barCode" />
      <el-table-column label="居民姓名" align="center" prop="residentInfo.name" />
      <el-table-column label="送检时间" align="center" prop="updateTime" width="180">
...
<script>
  import { listInspectRecord ,exportInspectRecord} from "@/api/basic/inspectRecordInfo";
  export default {
    name: "inspectRecord",
    data() {
      return {
    ...
    methods: {
      getList() {
        this.loading = true;
        listInspectRecord(this.queryParams).then(response => {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有岗位数据项?', "警告", {
          ...
          return exportInspectRecord(queryParams);
        }).then(response => {
