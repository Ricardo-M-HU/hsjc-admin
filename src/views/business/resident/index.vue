<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="出生日期" align="center" prop="bornDay" width="180"/>
      <el-table-column label="性别" align="center" prop="gender" />
      <el-table-column label="年龄" align="center" prop="age" />
      <el-table-column label="所在社区" align="center" prop="communityId" width="100"/>
      ...
      <el-table-column label="户籍" align="center" prop="certAddress" />
      <el-table-column label="序号" align="center" prop="sorting" />
...
<script>
  import { listResident ,exportResident} from "@/api/basic/resident";
  export default {
    name: "resident",
    data() {
      return {
    ...
    methods: {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有岗位数据项?', "警告", {
          ...
          return exportResident(queryParams);
        }).then(response => {
