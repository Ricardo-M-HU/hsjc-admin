  ...
  export default {
    ...
    methods: {
      initChart() {
        ...
        let xData = ["采集点1", "采集点1", "采集点1", "采集点1", "采集点1", "采集点1", "采集点1", "采集点1", "采集点1"];
        let lines = [
        ...
        let option = {
          ...
          tooltip: {
            ...
            formatter: function(param) {
              let resultTooltip = "<div style='background:rgba(13,5,30,.6);border:1px solid rgba(255,255,255,.2);padding:5px;border-radius:3px;'>" +
